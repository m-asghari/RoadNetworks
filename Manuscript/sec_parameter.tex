...
\begin{figure*}
    ...
    \subfigure[9:00am]{
        \label{fig:900}
        \includegraphics[width = 0.6\columnwidth]{figures/ltt_0900.pdf}
    }
    \subfigure[12:00pm]{
        \label{fig:1200}
        \includegraphics[width = 0.6\columnwidth]{figures/ltt_1200.pdf}
    }
    \subfigure[6:00pm]{
        \label{fig:1800}
        \includegraphics[width = 0.6\columnwidth]{figures/ltt_1800.pdf}
    }
